        ...
        <div class="row">
            <div class="col-sm">
                ...
                <form action="process_edit_article.php" method="post" enctype="multipart/form-data">
                    <!-- Trường ẩn chứa ID bài viết để xử lý cập nhật -->
                    <input type="hidden" name="articleId" value="123"> <!-- Giá trị sẽ được thay bằng ID thật của bài viết -->

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblTitle">Tiêu đề bài viết</span>
                        <input type="text" class="form-control" name="txtTitle" value="Tiêu đề bài viết hiện tại" required>
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCategory">Thể loại</span>
                        <select class="form-select" name="txtCategory" required>
                            <option value="Thể loại 1" selected>Thể loại 1</option>
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <select class="form-select" name="txtAuthor" required>
                            <option value="Tác giả 1" selected>Tác giả 1</option>
                    ...
                    <div class="input-group mt-3 mb-3">
                        <label for="fileUpload" class="me-3">Chọn hình ảnh bài viết mới (nếu có): </label>
                        <input type="file" name="image" id="fileUpload" accept="image/*">
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblContent">Nội dung bài viết</span>
                        <textarea class="form-control" name="txtContent" rows="5" required>Nội dung bài viết hiện tại</textarea>
                    </div>
