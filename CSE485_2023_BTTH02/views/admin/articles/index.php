...
<header>
    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-sm">
                <a href="index.php?controller=article&action=insert" class="btn btn-success mb-3">Thêm mới bài viết</a>
                        ...
                        <?php $stt=1;
                            foreach($articles as $article): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?controller=article&action=edit&id=<?php echo $article['ma_bviet']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </td>
                                        <td>
                                            <a href="index.php?controller=article&action=delete&id=<?php echo $article['ma_bviet']; ?>" onclick="return confirm('Bạn có muốn xóa bài viết <?php echo $article['tieude']; ?> này không?')"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach;  ?>
