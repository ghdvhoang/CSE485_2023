...
<header>
    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-sm">
                <a href="index.php?controller=author&action=insert" class="btn btn-success">Thêm mới</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                    ...
                    <tbody>
                        ...
                        foreach($authors as $author): ?>
                                    <tr>
                                        ...
                                        <td style="width: 50px;">
                                            <a href="index.php?controller=author&action=edit&id=<?php echo $author['ma_tgia']; ?>&name=<?php echo $author['ten_tgia']; ?> &path= <?php echo $author['hinh_anh']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </td>
                                        <td style="width: 50px;">
                                            <a href="index.php?controller=author&action=delete&id=<?php echo $author['ma_tgia']; ?>" onclick="return confirm('Bạn có muốn xóa tác giả: <?php echo $author['ten_tgia']; ?> không?')"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                    </tbody>
