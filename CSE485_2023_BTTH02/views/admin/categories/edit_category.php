            ...
            <div class="col-sm">
                ...
                <?php foreach($category as $cate): ?>
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtCatId" readonly value="<?php echo $cate['ma_tloai']; ?>">
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tên thể loại</span>
                        <input type="text" class="form-control" name="txtCatName" value = "<?php echo $cate['ten_tloai']; ?>">
                    </div>
                <?php endforeach;?>
