...
<header>
    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-sm">
                <a href="index.php?controller=category&action=insert" class="btn btn-success">Thêm mới</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                            ...
                            foreach($categories as $category): 
                                $stt++ ?>
                                         <tr>
                                            ...
                                            <td>
                                                <a href="index.php?controller=category&action=edit&id=<?php echo $category['ma_tloai']; ?> & name=<?php echo $category['ten_tloai'];  ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                            </td>
                                            <td>
                                                <a href="index.php?controller=category&action=delete&id=<?php echo $category['ma_tloai']; ?>" onclick="return confirm('Bạn có muốn xóa <?php echo $category['ten_tloai']; ?>')"><i class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
